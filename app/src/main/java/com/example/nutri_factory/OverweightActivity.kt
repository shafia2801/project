    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val foodItems = listOf(
            FoodItem(
                ...
                "gs://myfirebase-f9939.appspot.com/oo.jpg",
                "Breakfast: 2 egg with 1 cup of spinach"
            ),
            FoodItem(
                "Whole grain toast",
                "gs://myfirebase-f9939.appspot.com/f2.jpg",
                "Breakfast: 1 slice"
            ),
            FoodItem(
                "Almond milk",
                "gs://myfirebase-f9939.appspot.com/a.jpg",
                "Breakfast: 1 cup of unsweetened almond milk"
            ),
            FoodItem(
                "Tofu salad",
                "gs://myfirebase-f9939.appspot.com/ooo.jpg",
                "Dinner: 2 cups mixed greens, 2 tablespoons vinaigrette dressing"
            ),
            FoodItem(
                "Grilled chicken breast",
                "gs://myfirebase-f9939.appspot.com/g.jpg",
                "Lunch: 113 grams of cooked chicken breast, seasoned with herbs and spices."
            ),
            FoodItem(
                "Water with lemon",
                "gs://myfirebase-f9939.appspot.com/o2.jpg",
                "Lunch: 1 glass of water with 1 lemon"
            ),
            FoodItem(
                "Grilled fish fillet",
                "gs://myfirebase-f9939.appspot.com/f.jpg",
                "Dinner: 4-6 ounces of grilled fish seasoned with herbs and lemon juice."
            ),
            FoodItem(
                "Quinoa pilaf",
                "gs://myfirebase-f9939.appspot.com/p.jpg",
                "Dinner: 1/2 cup of cooked quinoa mixed with diced vegetables"
            ),
            FoodItem(
                "Citrus fruits",
                "gs://myfirebase-f9939.appspot.com/ff.jpg",
                "Dinner: 2 fruits. Avoid adding sugar or sweeteners."
            )
        )
